...
- Each segment must start at the first line that is 100% part of the skippable content.
    - Example: "...that's how the story goes, and now a word from our sponsor" - start the ad segment AFTER this line.
