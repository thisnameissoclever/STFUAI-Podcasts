...
(async () => {
    try {
        ...
        console.log('\x1b[34m[1/6] Checking for existing tag...\x1b[0m');
        try {
        ...
        console.log('\x1b[34m[2/6] Installing dependencies...\x1b[0m');
        execSync('npm install', { stdio: 'inherit' });

        // 3. Check git status
        console.log('\x1b[34m[3/6] Checking git status...\x1b[0m');
        ...
        // 4. Build
        console.log('\x1b[34m[4/6] Building application...\x1b[0m');
        execSync('npm run build', { stdio: 'inherit' });

        // 5. Publish
        console.log('\x1b[34m[5/6] Publishing release...\x1b[0m');
        ...
        console.log('\x1b[34m[6/6] Updating release description...\x1b[0m');
